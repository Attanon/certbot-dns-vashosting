"""
The `~certbot_dns_vashosting.dns_vashosting` plugin automates the process of
completing a ``dns-01`` challenge (`~acme.challenges.DNS01`) by creating, and
subsequently removing, TXT records using the Vashosting.cz vps centrum REST API.
Named Arguments
---------------
========================================  =====================================
``--dns-vashosting-credentials``          ISPConfig Remote API credentials_
                                          INI file. (Required)
``--dns-vashosting-propagation-seconds``  The number of seconds to wait for DNS
...
.. code-block:: bash
   ...
   certbot certonly \\
     --dns-vashosting \\
     --dns-vashosting-credentials ~/.secrets/certbot/ispconfig.ini \\
     -d example.com
.. code-block:: bash
...
.. code-block:: bash
   ...
   certbot certonly \\
     --dns-vashosting \\
     --dns-vashosting-credentials ~/.secrets/certbot/ispconfig.ini \\
     --dns-vashosting-propagation-seconds 240 \\
     -d example.com
"""
